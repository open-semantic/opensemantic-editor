    ...
    return (
        <div className="h-full flex items-center justify-center bg-gray-50">
            <div className="text-center max-w-2xl px-6">
                ...
                <p className="mt-1 text-sm text-gray-500">The YAML contains syntax errors and cannot be parsed.</p>
                {yamlParseError && (
                    <p className="mt-3 rounded bg-red-50 border border-red-200 px-3 py-2 text-xs text-red-700 font-mono text-left whitespace-pre-wrap">
                        {yamlParseError}
                    </p>
                )}
                <button onClick={onSwitchToYaml}
